...
module CTS
  ...
  private
    ...
    def create_case(flagged:)
      ...
      kase = if flagged
               create :accepted_case, :flagged, managing_team: @managing_team, responding_team:, responder:, approving_team: @dacu_disclosure
             else
               create(:accepted_case, managing_team: @managing_team, responding_team:, responder:)
             end
