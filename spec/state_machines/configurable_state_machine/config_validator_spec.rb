  ...
  describe 'ConfigValidator' do
    ...
    context 'validation of preamble/permitted_case_types' do
      it 'should error if none specified' do
        ...
        expect{
          validator.run
        }.to raise_error ConfigurationError, /File xxx.yml section preamble\/permitted_case_types: expected at least 1 entries, found 0/
      end
    end
    ...
    context 'validation of case_types' do
      it 'errors if no case type entry for  thise specified in preamble/permitted_case_types' do
        ...
        expect{
          validator.run
        }.to raise_error ConfigurationError,"File xxx.yml section case_types: Missing mandatory key: 'pq'"
      end
      ...
      it 'errors if case type entry specified which is not mentioned in peramble/permitted_case_types' do
        ...
        expect{
          validator.run
        }.to raise_error ConfigurationError, /File xxx.yml section case_types: Invalid key: 'pq'/
      end
    end
    ...
    context 'validation of a single case type' do
      context 'name attribute' do
        it 'errors if missing' do
          ...
          expect{
            validator.run
          }.to raise_error ConfigurationError, %q{File xxx.yml section case_types/foi: Missing mandatory key: 'name'}
        end
      end
      ...
      context 'permitted workflows is not an array' do
        it 'errors' do
          ...
          expect{
            validator.run
          }.to raise_error ConfigurationError, /File xxx.yml section case_types\/foi\/permitted_workflows: Expected an array, got RecursiveOpenStruct/
        end
      end
      ...
      context 'permitted workflows is a Fixnum' do
        it 'errors' do
          ...
          expect{
            validator.run
          }.to raise_error ConfigurationError, /File xxx.yml section case_types\/foi\/permitted_workflows: Expected an array, got Fixnum/
        end
      end
      ...
      context 'permitted states is not an array' do
        it 'errors' do
          ...
          expect{
            validator.run
          }.to raise_error ConfigurationError, /File xxx.yml section case_types\/foi\/permitted_states: Expected an array, got String/
        end
      end
      ...
      context 'validation of workflows' do
        context 'workflows is not a hash' do
          it 'errors' do
            ...
            expect{
              validator.run
            }.to raise_error ConfigurationError, 'File xxx.yml section case_types/foi: Expected workflows to be a Hash, is a Fixnum'
          end
        end
        ...
        context 'workflow name is not valid' do
          it 'errors' do
            ...
            expect{
              validator.run
            }.to raise_error ConfigurationError, 'File xxx.yml section case_types/foi/workflows: fantasy_workflow is not a permitted workflow'
          end
        end
        ...
        context 'workflow is missing initial state' do
          it 'errors' do
            ...
            expect{
              validator.run
            }.to raise_error ConfigurationError, 'File xxx.yml section case_types/foi/workflows/standard: Mandatory key :initial_state not specified'
          end
        end
        ...
        context 'initial_state is not a permitted state' do
          it 'errors' do
            ...
            expect{
              validator.run
            }.to raise_error ConfigurationError, 'File xxx.yml section case_types/foi/workflows/standard: Initial state unknown is not a permitted state'
          end
        end
        ...
        context 'workflow is missing user roles' do
          it 'errors' do
            ...
            expect{
              validator.run
            }.to raise_error ConfigurationError, 'File xxx.yml section case_types/foi/workflows/standard: Missing mandatory key: user_roles'
          end
        end
        ...
        context 'user roles is not a hash' do
          it 'errors' do
            ...
            expect{
              validator.run
            }.to raise_error ConfigurationError, 'File xxx.yml section case_types/foi/workflows/standard: Expected user_roles to be a Hash, got Fixnum'
          end
        end
        ...
        context 'not all user roles are in permitted roles' do
          it 'errors' do
            ...
            expect{
              validator.run
            }.to raise_error ConfigurationError, 'File xxx.yml section case_types/foi/workflows/standard/user_roles: User role drafter is not a permitted user role'
          end
        end
      end
      ...
      context 'validate user role' do
        context 'user role is not a hash' do
          it 'errors' do
            ...
            expect{
              validator.run
            }.to raise_error ConfigurationError, 'File xxx.yml section case_types/foi/workflows/standard/user_roles: Expected manager to be a hash, is a String'
          end
        end
        context 'user role doesnt have states key' do
          it 'errors' do
            ...
            expect{
              validator.run
            }.to raise_error ConfigurationError, /File xxx.yml section case_types\/foi\/workflows\/standard\/user_roles\/manager: Missing mandatory key: 'states'/
          end
        end
        context 'user role has an unrecognised key' do
          it 'errors' do
            ...
            expect{
              validator.run
            }.to raise_error ConfigurationError, "File xxx.yml section case_types/foi/workflows/standard/user_roles/manager: Invalid key: 'case_states'"
          end
        end
      end
      ...
      context 'validate user_role/state' do
        context 'unknown state specified' do
          it 'errors' do
            ...
            expect{
              validator.run
            }.to raise_error ConfigurationError, "File xxx.yml section case_types/foi/workflows/standard/user_roles/manager/states/: State unrecognised not a permitted state"
          end
        end
        ...
        context 'state is not a hash' do
          it 'errors' do
            ...
            expect{
              validator.run
            }.to raise_error ConfigurationError, "File xxx.yml section case_types/foi/workflows/standard/user_roles/manager/states: Expected drafting to be a Hash, is a String"
          end
        end
      end
