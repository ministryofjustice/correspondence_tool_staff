...
describe CaseFilter::ReceivedDateFilter do
  ...
  describe '#applied?' do
    ...
    context 'no received_date present' do
  ...
  describe '#call' do
    ...
    context 'no cases with received date in date range' do
      let(:search_query) { create :search_query,
    ...
    context 'case with received_date within date rang' do
  ...
  describe '#crumbs' do
    ...
    context 'no received_date from or to selected' do
      let(:search_query)  { create :search_query,
    ...
    context 'from and to date selected' do
      ...
      describe 'params that will be submitted when clicking on the crumb' do
        ...
        it { should eq 'received_date_from' => '',
                       'received_date_to' => '',
