...
describe DirectorateMoveService do
  ...
  let(:service) { DirectorateMoveService.new(directorate, target_dir) }
  let(:directorate) {
    find_or_create(
      :directorate,
  ...
  describe '#initialize' do
    it 'returns error when the team is not a directorate' do
      expect{
        DirectorateMoveService.new(business_unit, target_dir)
    ...
    it 'returns error when the target directorate is not a directorate' do
      expect{
        DirectorateMoveService.new(directorate, directorate)
    ...
    it 'returns error for the original business group' do
      expect{
        DirectorateMoveService.new(directorate, original_dir)
    ...
    context 'moving a directorate to another business group' do
      ...
      context 'when the team being moved is an approver team' do
        ...
        it 'it moves approver assignments to new team and users are preserved' do
          ...
          this_service = DirectorateMoveService.new(business_unit.directorate, target_dir)
          this_service.call
          business_unit.reload
