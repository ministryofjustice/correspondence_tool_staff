        ...
        let(:expected_results) do
          {
            ...
            "April" => {
              ...
              trigger_total: 4,
              trigger_responded_in_time: 4,
              trigger_responded_late: 0,
              trigger_open_in_time: 0,
              trigger_open_late: 0,
              overall_performance_pctg: 85.7,
              overall_total: 7,
              overall_responded_in_time: 4,
            ...
            "Total" => {
              ...
              trigger_perfomance_pctg: 85.7,
              trigger_total: 7,
              trigger_responded_in_time: 6,
              trigger_responded_late: 1,
              trigger_open_in_time: 0,
              trigger_open_late: 0,
              overall_performance_pctg: 66.7,
              overall_total: 12,
              overall_responded_in_time: 6,
              overall_responded_late: 1,
              overall_open_in_time: 2,
              overall_open_late: 3,
            },
