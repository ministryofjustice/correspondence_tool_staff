    ...
    describe '.description' do
      it 'returns correct description' do
        expect(described_class.description)
          .to eq 'Includes performance data about Offender ICO complaint requests we received and responded to from the beginning of the year by month.'
      end
    end
    ...
    describe '#case_scope' do
      ...
      before(:all) do
        Timecop.freeze Time.new(2019, 6, 30, 12, 0, 0) do
          @period_start = 0.business_days.after(Date.new(2019, 4, 01))
      ...
      it 'returns only Offender SAR cases within the selected period' do
        ...
        expect(report.case_scope).to match_array( [@oitandard_complaint_2, @oitandard_complaint_3, @oitandard_complaint_4])
      end

      context 'stats values' do
        it 'cases in different stages' do
          responded_late = nil
          Timecop.freeze Time.new(2019, 05, 20, 12, 0, 0) do
