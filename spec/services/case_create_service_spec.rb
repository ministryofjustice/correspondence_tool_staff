...
describe CaseCreateService do
  ...
  describe "#call" do
    ...
    context "when ICO case" do
      ...
      let(:deadline)          { received + 28.working.days }
      let(:internal_deadline) { deadline - 10.working.days }
      ...
      it "uses the params provided" do
        ...
        expect(created_case.internal_deadline).to eq((deadline - 10.working.days).to_date)
    ...
    context "when OverturnedSAR" do
      ...
      it "sets the escalation date to 20 working days before the external deadline" do
        ...
        expect(kase.internal_deadline).to eq kase.external_deadline - 20.working.days
      end
