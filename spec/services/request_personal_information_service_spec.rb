...
describe RequestPersonalInformationService do
  let(:valid_data) do
    {
  ...
  let(:service) { described_class.new(valid_data) }

  describe "#build" do
    it "returns a RequestPersonalInformation object from json" do
      expect(service.build).to be_a RequestPersonalInformation
    end
  end
end
