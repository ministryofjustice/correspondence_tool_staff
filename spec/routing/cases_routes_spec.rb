...
describe 'cases routes', type: :routing do
  ...
  describe '/cases redirects', type: :request do
    ...
    context 'manager user' do
      let(:user) { manager }
      xit { should redirect_to '/cases/open' }
    end
  ...
  describe get: '/cases/closed' do
    xit { should route_to 'cases#closed_cases' }
  end

  describe get: '/cases/deleted' do
    xit { should route_to 'cases#deleted_cases' }
  end

  describe get: '/cases/incoming' do
    xit { should route_to 'cases#incoming_cases' }
  end
  ...
  describe '/cases/my_open', type: :request  do
    ...
    xit { should redirect_to '/cases/my_open/in_time' }
  end

  describe get: '/cases/my_open/in_time' do
    xit { should route_to 'cases#my_open_cases', tab: 'in_time' }
  end
  ...
  describe patch: '/cases/1/unflag_for_clearance' do
    xit { should route_to 'cases#unflag_for_clearance', id: '1' }
  end

  describe patch: '/cases/1/flag_for_clearance' do
    xit { should route_to 'cases#flag_for_clearance', id: '1' }
  end

  describe get: '/cases/1/approve' do
    xit { should route_to 'cases#approve', id: '1' }
  end

  describe patch: '/cases/1/approve' do
    xit { should route_to 'cases#execute_approve', id: '1' }
  end

  describe get: '/cases/1/upload_responses' do
    xit { should route_to 'cases#upload_responses', id: '1' }
  end

  describe patch: '/cases/1/upload_responses' do
    xit { should route_to 'cases#execute_upload_responses', id: '1' }
  end

  describe get: '/cases/1/upload_response_and_approve' do
    xit { should route_to 'cases#upload_response_and_approve', id: '1' }
  end

  describe patch: '/cases/1/upload_response_and_approve' do
    xit { should route_to 'cases#execute_upload_response_and_approve', id: '1' }
  end

  describe get: '/cases/1/upload_response_and_return_for_redraft' do
    xit { should route_to 'cases#upload_response_and_return_for_redraft',
                         id: '1' }
  end

  describe patch: '/cases/1/upload_response_and_return_for_redraft' do
    xit { should route_to 'cases#execute_upload_response_and_return_for_redraft',
                         id: '1' }
  end
end
