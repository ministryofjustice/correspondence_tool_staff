...
RSpec.describe Api::RpiController, type: :controller do
  ...
  describe "authentication" do
    ...
    context "with unencrypted data" do
      it "responds with 401" do
        post(:create, body: { raw: "json" }.to_json)
  ...
  describe "#create" do
    ...
    context "with missing schema version" do
      ...
      it "defaults to schema version 1" do
        expect(RequestPersonalInformation::Data).to receive(:new).with(hash_including(submissionId: "0fc67a0a-1c58-48ee-baec-36f9f2aaebe3"))
