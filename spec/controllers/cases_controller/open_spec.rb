...
describe CasesController, type: :controller do
  describe 'GET open' do
    ...
    let(:current_page)       { instance_double(GlobalNavManager::Page,
                                               cases: open_cases) }
    let(:global_nav_manager) { instance_double(GlobalNavManager,
                                               current_page_or_tab: current_page) }

    let(:search_query)        { create :search_query, :list,
