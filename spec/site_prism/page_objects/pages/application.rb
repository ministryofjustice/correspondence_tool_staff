  ...
  module Pages
    module Application
...

      {
        ...
        cases_new_osar_subject_details:                 'Cases::New::OSARPageSubjectDetails',
        cases_new_osar_requester_details:                 'Cases::New::OSARPageRequesterDetails',
        cases_new_osar_requested_info:                 'Cases::New::OSARPageRequestedInfo',
        cases_new_osar_date_received:                 'Cases::New::OSARPageDateReceived',
