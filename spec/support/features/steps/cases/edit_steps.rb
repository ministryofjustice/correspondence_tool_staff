...
def edit_foi_case_closure_step(kase:, date_responded: Date.today)
  expect(cases_show_page).to be_displayed(id: kase.id)
  ...
  cases_edit_closure_page.is_info_held.other.click
  cases_edit_closure_page.other_reasons.clarification_required.click
