   ...
   def initialize
     @users = {
      ...
      @cases = {
         ...
         trig_awresp_foi: create(:assigned_case, :flagged_accepted, :dacu_disclosure, approver: approver),
         ...
         trig_closed_foi: create(:closed_case, :flagged_accepted, :dacu_disclosure, responder: responder, approver: approver, responder: responder, approver: approver),
         full_unassigned_foi: create(:case, :flagged_accepted, :press_office, responder: responder, approver: approver),
         full_awresp_foi: create(:assigned_case, :flagged_accepted, :press_office, responder: responder, approver: approver),
         ...
         full_ppress_foi: create(:pending_press_office_clearance_case, :flagged_accepted, :press_office, responder: responder,  approver: approver),
         full_pprivate_foi: create(:pending_press_office_clearance_case, :flagged_accepted, :press_office, responder: responder,  approver: approver),
