...
feature "editing case closure information" do
  ...
  scenario "bmt changes ico decision to overturned", js: true do
    Timecop.freeze(11.working.days.ago) do
      kase = create :closed_ico_foi_case
      Timecop.return
      login_as manager
      cases_show_page.load(id: kase.id)
      edit_ico_case_closure_step(kase:,
                                 decision_received_date: 10.working.days.ago,
  ...
  scenario "bmt changes ico decision to upheld", js: true do
    Timecop.freeze(11.working.days.ago) do
      kase = create :closed_ico_foi_case, :overturned_by_ico, created_at: 11.working.days.ago
      Timecop.return
      login_as manager
      cases_show_page.load(id: kase.id)
      edit_ico_case_closure_step(kase:,
