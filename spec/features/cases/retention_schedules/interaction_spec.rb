...
feature "Case retention schedules for GDPR", :js do
  ...
  scenario "non admin branston users cannot manage RRD schedules of cases" do
    ...
    expect(page).not_to have_content "RRD Pending"
  end
  ...
  scenario "branston team admin users can managers RRD schedules of cases" do
    ...
    expect(page).not_to have_content erasable_untimely_kase.number

    click_on "Pending removal"

    expect(page).to have_content "5 cases found"
    expect(page).not_to have_content "Destroy cases"
    ...
    expect(page).not_to have_content reviewable_untimely_kase.number
    expect(page).not_to have_content retain_untimely_kase.number
    ...
    expect(page).not_to have_content not_set_timely_kase.number
    expect(page).not_to have_content retain_timely_kase.number
  ...
  scenario "non branston users cannot see the GDPR tab" do
    ...
    expect(page).not_to have_content "Case Retention"
  end
