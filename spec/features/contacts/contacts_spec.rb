...
feature "Contacts address book", js: true do
  ...
  def then_the_state_remains_the_same
    ...
    expect(page).not_to have_content("Find a solicitor address")
  end
  ...
  def then_the_revealing_panel_is_not_visible
    expect(page).not_to have_content("Full name of the representative (optional)")
  end
  ...
  def and_the_relationship_field_should_not_be_visible
    expect(page).not_to have_content("Please specify relationship to the subject")
  end
