...
RSpec.describe CommissioningDocumentTemplate::Security do
  let(:kase) do
    FactoryBot.build_stubbed(:offender_sar_case,
      number: '20062007',
  ...
  let(:data_request) { FactoryBot.build_stubbed(:data_request, offender_sar_case: kase, location: 'HMP Brixton') }
