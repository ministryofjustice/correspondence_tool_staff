...
#                         closed_filter_cases GET    /cases/closed/filter(.:format)                                       cases#filter_closed_cases
#                                closed_cases GET    /cases/closed(.:format)                                              cases#closed_cases
#                               deleted_cases GET    /cases/deleted(.:format)                                             cases#deleted_cases
...
#                                approve_case GET    /cases/:id/approve(.:format)                                         cases#approve
#                                             PATCH  /cases/:id/approve(.:format)                                         cases#execute_approve
#                       upload_responses_case GET    /cases/:id/upload_responses(.:format)                                cases#upload_responses
#                                             PATCH  /cases/:id/upload_responses(.:format)                                cases#execute_upload_responses
#            upload_response_and_approve_case GET    /cases/:id/upload_response_and_approve(.:format)                     cases#upload_response_and_approve
#                                             PATCH  /cases/:id/upload_response_and_approve(.:format)                     cases#execute_upload_response_and_approve
# upload_response_and_return_for_redraft_case GET    /cases/:id/upload_response_and_return_for_redraft(.:format)          cases#upload_response_and_return_for_redraft
#                                             PATCH  /cases/:id/upload_response_and_return_for_redraft(.:format)          cases#execute_upload_response_and_return_for_redraft
...
Rails.application.routes.draw do
  ...
  resources :cases, except: :new do
    ...
    get 'closed/filter' => 'cases#filter_closed_cases', on: :collection
