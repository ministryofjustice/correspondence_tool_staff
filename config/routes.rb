...
Rails.application.routes.draw do
  ...
  scope :cases, module: 'cases' do
    ...
    resources :offender_sars, only: only, controller: 'offender_sar', as: :case_sar_offender do
      ...
      get '/sent_to_sscl', on: :member, to: 'offender_sar#sent_to_sscl', as: 'sent_to_sscl'
      patch '/sent_to_sscl', on: :member, to: 'offender_sar#confirm_sent_to_sscl', as: 'confirm_sent_to_sscl'
      member do
