...
Rails.application.routes.draw do
  ...
  scope :cases, module: "cases" do
    ...
    resources :offender_sar_complaints, only:, controller: "offender_sar_complaint", as: :case_sar_offender_complaint do
      ...
      get "/edit/acknowledgement_sent", on: :member, to: "offender_sar_complaint#acknowledgement_sent", as: "acknowledgement_sent"
      patch "/edit/acknowledgement_sent", on: :member, to: "offender_sar_complaint#confirm_acknowledgement_sent", as: "confirm_acknowledgement_sent"
