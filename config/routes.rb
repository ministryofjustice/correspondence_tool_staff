...
Rails.application.routes.draw do
  ...
  scope :cases, module: "cases" do
    ...
    resources :icos, only:, controller: "ico", as: :case_ico do
      ...
      get "record_sar_complaint_outcome", on: :member, to: "ico_sar#require_record_sar_complaint_outcome"
      patch "record_sar_complaint_outcome", on: :member, to: "ico_sar#confirm_record_sar_complaint_outcome"
    end
