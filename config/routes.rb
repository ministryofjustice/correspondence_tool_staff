...
Rails.application.routes.draw do
  ...
  scope :cases, module: "cases" do
    ...
    resources :offender_sars, only:, controller: "offender_sar", as: :case_sar_offender do
      ...
      get "/reason_rejected", on: :member, to: "offender_sar#reason_rejected", as: "reason_rejected"
      patch "/reason_rejected", on: :member, to: "offender_sar#confirm_reason_rejected", as: "confirm_reason_rejected"
