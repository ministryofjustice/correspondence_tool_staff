...
Rails.application.routes.draw do
  ...
  # oh dear we seem to have duplicate names for these overturned things
  resources :case_foi_overturneds, only: [:create], controller: :overturned_foi_cases do
    get :new_overturned_ico, on: :member
  end
  # This name is the one generated by form_for - so maybe the first one is bogus
  resources :case_overturned_ico_fois, only: [:create], controller: :overturned_foi_cases

  resources :case_sar_overturneds, only: [:create], controller: :overturned_sar_cases do
    get :new_overturned_ico, on: :member
  end
  # This name is the one generated by form_for
  resources :case_overturned_ico_sars, only: [:create], controller: :overturned_sar_cases
  ...
  resources :cases, except: [:new, :create] do
    ...
    # This is creating a new overturned case from the current one
