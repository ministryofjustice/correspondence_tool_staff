...
# This is a very basic deployment script that will deploy the current
# working copy into the desired environment. Run this file from the same
# directory as the Dockerfile
#
# e.g $> ./config/kubernetes/_deploy/cloud-platform-deploy.sh staging
#
# Note fixed docker container tag
