...
class StatsController < ApplicationController
  ...
  def download_custom
    ...
    if report.report_type.etl?
      ...
      # Basic authorization check to prevent download URLs being shared
      if info[:user_id] != current_user.id
        raise Pundit::NotAuthorizedError.new('Cannot download report generated by another user')
      end

      redis = Redis.new
      file = redis.get(info[:report_guid])
      puts "\nGot FILE: #{file}\n"
