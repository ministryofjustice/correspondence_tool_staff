  ...
  class CaseReport < ApplicationRecord
    ...
    class << self
      ...
      def generate(kase)
        ...
        case_report.rejected_reasons = kase.respond_to?(:rejected_reasons) ? kase.rejected_reasons : nil
        case_report.other_rejected_reason = kase.respond_to?(:other_rejected_reason) ? kase.other_rejected_reason : nil
