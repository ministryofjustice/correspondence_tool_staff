  ...
  class CaseReport < ApplicationRecord
    ...
    class << self
      ...
      def generate(kase)
        ...
        case_report.cost_paid = kase.offender_sar_complaint? ? kase.cost_paid : nil
        case_report.settlement_cost_paid = kase.offender_sar_complaint? ? kase.settlement_cost_paid : nil
