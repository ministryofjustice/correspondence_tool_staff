...
class CaseTransition < ApplicationRecord
  ...
  belongs_to :acting_user, class_name: User.to_s
  belongs_to :acting_team, class_name: Team.to_s
  belongs_to :target_user, class_name: User.to_s
  belongs_to :target_team, class_name: Team.to_s
