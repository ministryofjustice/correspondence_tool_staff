module Stats
  class StandardSARAnalyser
    COMMON_SUPERHEADINGS = {
      ...
      non_trigger_max_achievable: "Max achieveable",
      non_trigger_total: "Non-trigger cases",
      non_trigger_sar_extensions: "Extended",
      non_trigger_stopped: "Paused",
      ...
      trigger_max_achievable: "Max achieveable",
      trigger_total: "Trigger cases",
      trigger_sar_extensions: "Extended",
      trigger_stopped: "Paused",
      ...
      overall_max_achievable: "Max achieveable (Overall)",
    ...
    COMMON_COLUMNS = {
      ...
      trigger_stopped: "Status - included in overall",
