module CaseClosure
  class MetadataSeeder
    ...
    def self.seed_outcomes(verbose)
      Rails.logger.debug "----Seeding CaseClosure::Outcomes----" if verbose
    ...
    def self.seed_appeal_outcomes(verbose)
      Rails.logger.debug "----Seeding CaseClosure::AppealOutcomes----" if verbose
    ...
    def self.seed_refusal_reasons(verbose)
      Rails.logger.debug "----Seeding CaseClosure::RefusalReasons----" if verbose
    ...
    def self.seed_exemptions(verbose)
      Rails.logger.debug "----Seeding CaseClosure::Exemptions----" if verbose
    ...
    def self.seed_outcome_reasons(verbose)
      Rails.logger.debug "----Seeding CaseClosure::OutcomeReasons----" if verbose
    ...
    def self.implement_jan_2021_changes(verbose)
      Rails.logger.debug "Updating Case Closure data inline with January 2021 changes" if verbose
    ...
    def self.implement_feb_2021_changes(verbose)
      Rails.logger.debug "Updating Case Closure data inline with February 2021 changes" if verbose
