  ...
  def seed!
    ...
    rec.update!(name: 'Prisoner disclosed letter',
                ...
                body: <<~EOF
                  ...
                  <br>
                  <br>Finally, the MoJ is sorry that your SAR was not completed within 40 days. We take our obligations under the DPA very seriously and we make every effort to complete all SARs by the statutory deadline but regrettably there are occasions when we are unable to achieve this.                   </p>
                  </p>
                EOF
                )
  end
