    ...
    rec.update!(name: 'Prisoner disclosed letter',
                ...
                body: <<~EOF
                  <p>
                    <strong>
                      DATA PROTECTION ACT 2018:  SUBJECT ACCESS REQUEST
                      <br><%= values.subject_full_name&.upcase %>-<%= values.prison_number&.upcase %>
                    </strong>
                    <br>
                    ...
                    <br>
                    <br>I would like to suggest that you do not keep this information where it can be accessed by others. Once you have read through the information it can be placed in your stored property.
                    <br>
    ...
    rec.update!(name: 'Prisoner disclosed letter (COVID-19)',
                ...
                body: <<~EOF
                  <p>
                    ...
                    <br>
                    <br>Finally, should you require a copy of any other personal information held by the MoJ, we invite you to submit a new SAR once the COVID-19 pandemic is over. Unfortunately, we are unable to advise when this will be at present. 
                  </p>
                EOF
                )

    rec = LetterTemplate.find_by(abbreviation: 'prisoner-disclosed-cover-letter-covid')
    rec = LetterTemplate.new if rec.nil?
    rec.update!(name: 'Prisoner disclosed cover letter (COVID-19)',
                ...
                body: <<~EOF
                  <p>
                    ...
                    <br>
                    <strong>
                      This letter must not be seen by the offender. Once the parcel has been passed to the offender please ensure this covering letter is destroyed securely. 
                    </strong>
                    <br>
